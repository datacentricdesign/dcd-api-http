...
![Flowchart Push Button](../images/dcdhub.png =100x20)

Sign up as a group with an email address, a name and a password.

![Flowchart Push Button](../images/signup.png =100x20)
